            ...
            <form id="profileform" enctype="multipart/form-data" method="POST" action="javascript:void(0);">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-2">
                        <x-imageuploade inputId="customFile2" labelname="Select Image" id="profile_img" name="profile_image"
                            labelId="profile_img" previewId="profile_img_prev" :width="'50%'" :height="'100%'" />
                    </div>
        ...
        <script>
            $('#profileform').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: `{{ url('User/profile/${admin_id}/Update') }}`,
