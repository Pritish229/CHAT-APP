    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('User.Events') }}" class="{{ in_array(Route::currentRouteName(), ['User.Events','User.Tickets']) ? 'active' : '' }}">
                        <i class="fas fa-image" style="color: #545a6d;font-size: 0.99rem;"></i>
                        <span data-key="t-dashboard">Events</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('User.TicketHistory') }}" class="{{ in_array(Route::currentRouteName(), ['User.TicketHistory']) ? 'active' : '' }}">
                        <i class="fas fa-history" style="color: #545a6d;font-size: 0.99rem;"></i>
                        <span data-key="t-dashboard">History</span>
                    </a>
                </li>
               

                <!-- Manage Gallery Route -->
                {{-- <li class="{{ in_array(Route::currentRouteName(), ['Admin.Manage-Gallery.View-Gallery',]) ? 'mm-active' : '' }}">
                    <a href=" javascript: void(0);" class="has-arrow">
                        <i class="fas fa-image" style="color: #545a6d;font-size: 0.99rem;"></i>
                        <span data-key="t-authentication">Manage Gallery</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li class="{{ in_array(Route::currentRouteName(), ['Admin.Manage-Gallery.AddGallery',]) ? 'active' : '' }}"><a href="{{ route('Admin.Manage-Gallery.Page') }}" data-key="t-alerts" aria-expanded="false"><span>Add Images</span></a></li>
