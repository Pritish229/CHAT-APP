        ...
        <div class="d-flex">
            <div class="">
                <button type="button" class="btn header-item" id="mode-setting-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="feather feather-moon icon-lg layout-mode-dark">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-sun icon-lg layout-mode-light">
            ...
            <div class="dropdown d-inline-block">
                <button type="button"
                    ...
                    <img class="rounded-circle header-profile-user" id="header-profile-img"
                        src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="Header Avatar">
                    <div class="d-none d-xl-inline-block ms-1
                        fw-medium" id="user-title"></div>
                    <i class="mdi mdi-chevron-down d-none
                        d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('User.ProfilePage') }}"><i
                            class="mdi mdi mdi-face-man font-size-16
                            align-middle me-1"></i>
                        Profile</a>
