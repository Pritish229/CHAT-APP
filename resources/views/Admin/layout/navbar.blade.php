            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item
                    ...
                    <span class="d-none d-xl-inline-block ms-1
                        fw-medium" id="user-title">Pritish Ranjan Dash</span>
                    <i class="mdi mdi-chevron-down d-none
                        d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('Admin.ProfilePage') }}"><i class="mdi mdi mdi-face-man font-size-16
                            align-middle me-1"></i> Profile</a>
                   
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('Admin.Logout') }}"><i class="mdi
